...
//
// SKILL.md points at layered docs as the place the A-share specifics
// live; a broken link quietly strands the content behind it. Scan
// SKILL.md and references/ for [text](target) links, skip external
// URLs and bare anchors, resolve each target against the file that
// contains it, and fail on a miss. A miss means the target file was
// renamed, moved, or deleted -- fix the link, do not add exceptions.
